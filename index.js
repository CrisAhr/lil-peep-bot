...
+ 'FN:Lil Peep-Bot\n' // Nama
+ 'ORG:Lil Peep-Bot;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=15102272913:+1(510)227-2913\n' // Nomor bot
+ 'END:VCARD' 
...
┃ _Ex : ${prefix}Tahta .Lil Peep-Bot_
┗━━━━━━━━━━━━━━━━━━━━
*〘 TEXTO2 〙*
┏━━━━━━━━━━━━━━━━━━━━
...
┃ _Ex : ${prefix}Ephoto 25 Lil Peep-Bot_
┠⊷️ *${prefix}Textpro list*
┃ _Lista de textpro
┠⊷️ *${prefix}Textpro (code + Texto)*
┃ _Ex : ${prefix}Textpro 55 Lil Peep-Bot_
┗━━━━━━━━━━━━━━━━━━━━
*〘 IMAGENES 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Cogan*
...
pok = await getBuffer(nimek)
Lxa.sendMessage(from, pok, image, {
  quoted: mek, caption: `.Lil Peep-Bot`
})
...
//--Convert stiker to image
				case 'toimg':
					...
					exec(`ffmpeg -i ${medimg} ${ran}`, (err) => {
						...
						buffer = fs.readFileSync(ran)
						Lxa.sendMessage(from, buffer, image, {quoted: mek, caption: 'Lil Peep-Bot'})
						fs.unlinkSync(ran)
					})
					break
